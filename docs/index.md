...
- [Физические лица](#методы-по-физическим-лицам) — паспорт, арбитраж КАД, ФССП, банкротство, залоги
- [Юридические лица](#методы-по-юридическим-лицам) — арбитраж КАД по ИНН
- [Имущество](#методы-по-имуществу) — Росреестр и залоги по VIN/ID
...
| **fns_block**     | Блокировки счетов юрлиц (ФНС, приостановление операций) |
