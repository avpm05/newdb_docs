...
- [Проверка по VIN](../10-pledge_vin.md) — поиск залогов и обременений по номеру VIN автомобиля
- [Проверка по ID имущества](../11-pledge_id.md) — поиск залогов и обременений по идентификатору имущества
